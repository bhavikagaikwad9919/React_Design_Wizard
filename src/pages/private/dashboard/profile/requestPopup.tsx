  ...
  return (
    <PopupBox>
      <Box>
        {props.content}
        <PlanBox>
          <HeadOne>Data Request Failed</HeadOne>
          <HeadTow>
            You have already made a request for data in the last 10 days. Please
            check your emails for the link to your previous request. If you have
            any questions or need anything else please don't hesitate to contact
            us.
          </HeadTow>
